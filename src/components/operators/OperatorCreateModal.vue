...
async function handleSubmit() {
    if (!form.value.firstName || !form.value.lastName || !form.value.email || !form.value.dni) {
        notifyError({ title: 'Campos incompletos', description: 'Completa todos los campos obligatorios.' })
        return
    }
